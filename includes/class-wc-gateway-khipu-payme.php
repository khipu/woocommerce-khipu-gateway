...
class WC_Gateway_khipu_payme extends WC_Gateway_khipu_abstract
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('khipu PayMe', 'woocommerce-gateway-khipu');
        ...
        $this->icon = $this->get_payment_method_icon('PAY_ME');
    ...
    {
        return $this->is_payment_method_available_in_khipu('PAY_ME');
    }
        ...
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'description' => __('This controls the title which the user sees during checkout.',
                    'woocommerce'),
                'default' => __('khipu - PayMe Crédito y Débito', 'woocommerce-gateway-khipu'),
                'desc_tip' => true
            ),
            'description' => array(
                ...
                'description' => __('Payment method description that the customer will see on your checkout.',
                    'woocommerce'),
                'default' => __('Paga con cualquier Tarjeta de Crédito o Débito.', 'woocommerce-gateway-khipu')
            ),
        );
    ...
    function receipt_page($order)
    {
        ...
        if(method_exists($response, 'getPaymeUrl')) {
            wp_redirect($response->getPaymeUrl());
        } else {
            echo $response;
        }
    }
