...
class WC_Gateway_khipu_simplified_transfer extends WC_Gateway_khipu_abstract
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf(__('Khipu pago con Transferencia Simplificada', 'woocommerce-gateway-khipu'), admin_url('admin.php?page=wc-settings&tab=checkout&section=khipu'));
    ...
    function is_valid_currency() {
        if (in_array(get_woocommerce_currency(),
            apply_filters('woocommerce_' . $this->id . '_supported_currencies', array('CLP','ARS','EUR')))
        ) {
            return true;
        }
    }
